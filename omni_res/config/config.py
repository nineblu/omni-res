...
def get_config(config_path):
    ...
    """
    cfg_file = pkg_resources.resource_filename("simrec.config", os.path.join("configs", config_path))
    if not os.path.exists(cfg_file):
        raise RuntimeError("{} not available in simrec configs!".format(config_path))
